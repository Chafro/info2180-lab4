window.onload = function() {
	...
	document.getElementsByTagName("div")[3].onmouseover = function() {hover(3)};
	document.getElementsByTagName("div")[3].onmouseout = function() {hoverO(3)};
	document.getElementsByTagName("div")[4].onmouseover = function() {hover(4)};
	document.getElementsByTagName("div")[4].onmouseout = function() {hoverO(4)};
	document.getElementsByTagName("div")[5].onmouseover = function() {hover(5)};
	document.getElementsByTagName("div")[5].onmouseout = function() {hoverO(5)};
	document.getElementsByTagName("div")[6].onmouseover = function() {hover(6)};
	document.getElementsByTagName("div")[6].onmouseout = function() {hoverO(6)};
	document.getElementsByTagName("div")[7].onmouseover = function() {hover(7)};
	document.getElementsByTagName("div")[7].onmouseout = function() {hoverO(7)};
	document.getElementsByTagName("div")[8].onmouseover = function() {hover(8)};
	document.getElementsByTagName("div")[8].onmouseout = function() {hoverO(8)};
	document.getElementsByTagName("div")[9].onmouseover = function() {hover(9)};
	document.getElementsByTagName("div")[9].onmouseout = function() {hoverO(9)};
	document.getElementsByTagName("div")[10].onmouseover = function() {hover(10)};
	document.getElementsByTagName("div")[10].onmouseout = function() {hoverO(10)};
	document.getElementsByTagName("div")[11].onmouseover = function() {hover(11)};
	document.getElementsByTagName("div")[11].onmouseout = function() {hoverO(11)};
